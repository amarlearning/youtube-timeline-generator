...
from llm_video_timeline_description.utils import split_and_clean_srt_content, get_time_bucketing, postprocessing
...
def submit_video():
    ...
    processed_response = postprocessing(aggregated_time_buckets)
